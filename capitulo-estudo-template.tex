...
Neste semestre foi utilizada uma abordagem híbrida com abordagem tradicional de ensino
e aprendizagem, e abordagem \ac{PBL}.
...
Foram escolhidos #1 problemas, para trabalhar o
...
pelo educador.
Ao longo deste semestre, os
estudantes {\ifthenelse{\equal{#2}{1}}{construíram uma apresentação (um seminário)}
...
aos estudantes do funcionamento da abordagem \ac{PBL} e por não abordar
...
Um detalhe a se considerar é que embora as discussões referentes ao sexto problema
tenham seguido a abordagem \ac{PBL}, o produto esperado não foi a resolução
do problema, mas respostas para uma lista de exercícios.
...
a abordagem \ac{PBL} para os estudantes.
#1

O objetivo deste problema é mostrar aos estudantes
a condução com a abordagem.
}
