...
\input{capitulo-resultados-hipoteses}

É possível perceber que apenas o problema ``\ProblemaD'' obteve
validação para todas as hipóteses específicas, conforme os
critérios definidos, em duas replicações e que o
problema ``\ProblemaA'' obteve validação para todas as
hipóteses específicas, conforme os
critérios definidos, na única replicação.
...
como em nossa replicação do semestre 2017.1, para que aumentar
...
replicações do semestre 2017.1 a quantidade total
...
Nossa experiência sugere utilizar ao menos um tutor entre
cada dez e quinze estudantes.
