...
já {\ifthenelse{\equal{#5}{0}}{desistiu}{desistiram}} de outras disciplinas.}
...
às percepções dos participantes na aplicação do
...
A Figura~\ref{percep-#1} apresenta um gráfico com os resultados referentes
à percepção geral dos participantes #2 do semestre #3 sobre a disciplina.
...
previamente definidos em {\ifthenelse{\equal{#3}{1}}{apenas uma aplicação}{#3 aplicações}}.}
...
{\ifthenelse{\equal{#5}{}}{}{ na aplicação do semestre #5}}%
{\ifthenelse{\equal{#6}{}}{}{%
{\ifthenelse{\equal{#7}{}}%
{ e para o problema ``#6''}
{\ifthenelse{\equal{#8}{}}
...
{não houve concordância em parte}{a concordância em parte foi de $#2\%$}},
enquanto no semestre #3 {\ifthenelse{\equal{#4}{100,0}}
{não houve concordância em parte}{a concordância em parte foi de $#4\%$}}.}
...
Também é destaque que em #1 das #2 aplicações o atingimento da
