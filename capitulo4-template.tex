...
{\ifthenelse{\equal{#3}{0}}{desistiram da}{concluiram a}}
...
\newcommand{\AprovacaoDisciplina}[5]{%
No que diz respeito a #3 condução da disciplina (#5),
{\ifthenelse{\equal{#1}{100,0}}{todos os}%
{{\ifthenelse{\equal{#1}{0,0}}{nenhum dos}{$#1\%$ dos}}}}
participantes #2 mencionaram, em algum nível,
...
\newcommand{\AprovacaoDisciplinaF}[3]{%
A maioria dos participantes entende que #2 (#3), onde
{\ifthenelse{\equal{#1}{100,0}}{todos os}%
