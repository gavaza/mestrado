...
\newcommand{\AvaliacaoHipotese}[4]{\AvaliacaoHipoteseBase{#1}{#2}{#3} a afirmativa
``#4''.
}

\newcommand{\AvaliacaoHipoteseA}[5]{\AvaliacaoHipoteseBase{#1}{#2}{#3} as afirmativas
``#4'' e ``#5''.
}

\newcommand{\AvaliacaoHipoteseB}[6]{\AvaliacaoHipoteseBase{#1}{#2}{#3} as afirmativas
``#4'', ``#5'' e ``#6'' .
}

\newcommand{\AprovacaoHipotese}[4]{Ao analisar os resultados obtidos para as respostas
dos participantes para a{\ifthenelse{\equal{#4}{1}}{s}{}}
...
#2atende{\ifthenelse{\equal{#4}{1}}{m}{}} os critérios
previamente definidos em #3 replicações.}

\newcommand{\AprovacaoHipoteseResultado}[4]{O resultado
{\ifthenelse{\equal{#1}{0}}{}{não }}permite concluir
sobre a validade da hipótese com os critérios
definidos{\ifthenelse{\equal{#2}{}}{.}{}
{\ifthenelse{\equal{#3}{}}{ para o problema #2.}{
{\ifthenelse{\equal{#4}{}}{ para os problemas #2 e #3.}
...
\newcommand{\HipoteseFavorabilidadeDestaque}[4]{O
principal destaque para esta avaliação
está{\ifthenelse{\equal{#1}{}}{}{na afirmativa``#1''}} na
...
\newcommand{\HipoteseFavorabilidadeDestaqueContinuidade}[2]{No
semestre #1 a percepção de favorabilidade para a questão em
destaque, para este mesmo problema, teve um
atingimento {\ifthenelse{\equal{#2}{100,0}}{também integral}{de $#2\%$}}.
}
...
\newcommand{\HipoteseFavorabilidadeDestaqueOutra}[4]{Outro destaque
...
\AvaliacaoHipotese{\heatexto}{he1ref}{he}{\LikertPQ}
